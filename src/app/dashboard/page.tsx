...
export default function DashboardPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      {/* Contributor Stats Card - Show only if user has contributed */}
      {(stats.questionsContributed || 0) > 0 && (
        <div className="mb-8">
          <div className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-2xl p-6 shadow-lg border border-purple-200">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-lg font-bold text-slate-800">Contributor Stats</h3>
            </div>
            <p className="text-sm text-slate-600 mb-4">
              Thank you for contributing to PrepGenie's question bank! Your questions help thousands of students prepare better.
            </p>
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white rounded-xl p-4 border border-purple-100">
                ...
                <div className="text-sm text-slate-600 mt-1">Questions Contributed</div>
              </div>
              <div className="bg-white rounded-xl p-4 border border-indigo-100">
                <div className="text-3xl font-bold text-indigo-600">
                  {stats.contributionPoints}
                </div>
                <div className="text-sm text-slate-600 mt-1">Contribution Points</div>
              </div>
            </div>
            {(stats.contributionPoints || 0) >= 100 && (
              <div className="mt-4 flex items-center gap-2 text-sm">
                <span className="text-amber-500">🏆</span>
                <span className="text-slate-700 font-medium">
                  {(stats.contributionPoints || 0) >= 500 ? 'Expert Contributor' :
                   (stats.contributionPoints || 0) >= 250 ? 'Master Contributor' :
                   'Rising Contributor'}
                </span>
              </div>
            )}
