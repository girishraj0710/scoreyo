  ...
  return (
    <>
      ...
      <div className="fixed top-4 left-4 z-50">
        <a
          href="/"
          className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-md text-[#F5E6C8] rounded-xl hover:bg-white/20 font-semibold shadow-lg border border-white/20 transition-all"
        >
