          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="space-y-4">
                <div className={`p-4 rounded-lg ${currentDialogue?.speaker === "You" ? "bg-[#E3F2FD] border-2 border-blue-200" : "bg-gray-50"}`}>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-6">
                ...
                <div className="space-y-3">
                  <button
                    ...
                    className="w-full bg-[#4F9CF9] text-white py-3 px-4 rounded-lg font-semibold hover:bg-[#3B7FD9] transition flex items-center justify-center gap-2"
                  >
