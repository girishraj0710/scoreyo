        ...
        <div className="max-w-6xl mx-auto px-4 py-16">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-16 items-stretch">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-slate-200 flex flex-col h-full">
              <div className="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center mb-4 flex-shrink-0">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-slate-200 flex flex-col h-full">
              <div className="w-12 h-12 bg-cyan-100 rounded-xl flex items-center justify-center mb-4 flex-shrink-0">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg border border-slate-200 mb-16">
            <h2 className="text-2xl font-bold text-blue-700 mb-6 text-center">Why Choose Our English Hub?</h2>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                <div className="w-16 h-16 bg-cyan-100 rounded-full flex items-center justify-center mx-auto mb-3">
                  <TrendingUp className="w-8 h-8 text-blue-600" />
                </div>
                <h3 className="font-semibold text-blue-700 mb-2">AI-Powered Learning</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-blue-700 mb-2">Daily Practice Streaks</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-blue-700 mb-2">Rich Explanations</h3>
          ...
          {/* CTA */}
          <div className="text-center">
            <h2 className="text-2xl font-bold text-blue-700 mb-4">Ready to Master English?</h2>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <Link href="/english/assessment">
                <button className="bg-white text-blue-600 px-6 py-3 rounded-lg font-semibold hover:bg-blue-50 transition-all">
                  Start Assessment →
                </button>
              </Link>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-stretch">
            {englishPaths.map((path) => {
              ...
              <Link key={path.id} href={`/english/${path.id}`} className="h-full">
                <div
                  className="bg-white rounded-2xl p-6 shadow-sm border-2 border-slate-200 hover:border-blue-400 hover:shadow-lg transition-all cursor-pointer group h-full flex flex-col"
                ...
                >
                  <div className="flex items-start gap-4 flex-1">
                    ...
                    <div className="flex-1 flex flex-col">
                      <h3 className="text-xl font-bold text-slate-900 mb-2 group-hover:text-blue-600 transition-colors min-h-[3.5rem]">
                        {path.name}
                      </h3>
                      ...
                      <div className="flex flex-wrap gap-2 mb-3">
                        <span className="px-3 py-1 bg-cyan-100 text-blue-700 text-xs font-medium rounded-full">
                          {getLevelBadge(path)}
                        </span>
                        <span className="px-3 py-1 bg-cyan-100 text-blue-700 text-xs font-medium rounded-full">
