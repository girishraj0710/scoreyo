export const metadata = {
  title: "Terms of Service | PrepGenie",
  description: "Terms of Service for PrepGenie - AI-powered exam preparation platform",
};
        ...
        <div className="prose prose-slate max-w-none">
          <section className="mb-8">
            ...
            <p className="text-slate-600 mb-4">
              By accessing or using PrepGenie (&quot;Service&quot;), you agree to be bound by these Terms of Service.
              If you do not agree to these terms, please do not use our Service.
            </p>
            <p className="text-slate-600">
              PrepGenie is operated by PrepGenie and provides AI-powered exam preparation services for
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-600">
              <strong>2.3 Age Requirement:</strong> You must be at least 13 years old to use PrepGenie.
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-slate-800 mb-4">5. Refund Policy</h2>
            <p className="text-slate-600 mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-slate-800 mb-4">6. Content and Intellectual Property</h2>
            <p className="text-slate-600 mb-3">
              <strong>6.1 Our Content:</strong> All questions, explanations, reports, and materials provided by PrepGenie
            ...
            <ul className="list-disc list-inside text-slate-600 mb-3 ml-4">
              <li>Copy, distribute, or sell PrepGenie content</li>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-slate-800 mb-4">7. AI-Generated Content</h2>
            <p className="text-slate-600 mb-3">
              <strong>7.1 Question Sources:</strong> PrepGenie uses a combination of:
            </p>
            <ul className="list-disc list-inside text-slate-600 mb-3 ml-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-slate-800 mb-4">8. User Conduct</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-slate-800 mb-4">10. Disclaimers</h2>
            <p className="text-slate-600 mb-3">
              <strong>10.1 Educational Tool:</strong> PrepGenie is a study aid and practice platform. Success in actual
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-600 mb-3">
              To the maximum extent permitted by law, PrepGenie shall not be liable for:
            </p>
            <ul className="list-disc list-inside text-slate-600 mb-3 ml-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-slate-800 mb-4">15. Contact Us</h2>
            <p className="text-slate-600 mb-3">
          ...
          <div className="mt-12 p-6 bg-slate-50 rounded-xl border border-slate-200">
            <p className="text-sm text-slate-600">
              By using PrepGenie, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.
            </p>
          </div>
        </div>
        </div>
