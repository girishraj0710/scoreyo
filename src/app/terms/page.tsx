  ...
  return (
    <div className="min-h-screen " style={{ background: "var(--background)" }}>
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className=" rounded-2xl shadow-lg border  p-8 md:p-12" style={{ borderColor: "var(--card-border)" }} style={{ background: "var(--card-bg)" }}>
        <h1 className="text-4xl font-bold  mb-4" style={{ color: "var(--foreground)" }}>Terms of Service</h1>
        <p className=" mb-8" style={{ color: "var(--foreground)" }}>Last updated: May 16, 2026</p>
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside  mb-3 ml-4" style={{ color: "var(--foreground)" }}>
          ...
          <section className="mb-8">
            ...
            <ul className="list-none  ml-0" style={{ color: "var(--foreground)" }}>
          ...
          <div className="mt-12 p-6  rounded-xl border " style={{ background: "var(--background)" }} style={{ borderColor: "var(--card-border)" }}>
