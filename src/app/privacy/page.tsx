      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-slate-800 mb-3">2.3 Performance and Analytics Data</h3>
            <ul className="list-disc list-inside text-slate-600 mb-4 ml-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-slate-800 mb-3 mt-6">3.1 Provide and Improve Services</h3>
            <ul className="list-disc list-inside text-slate-600 mb-4 ml-4">
            ...
            <h3 className="text-xl font-semibold text-slate-800 mb-3">3.2 Communication</h3>
            <ul className="list-disc list-inside text-slate-600 mb-4 ml-4">
            ...
            <h3 className="text-xl font-semibold text-slate-800 mb-3">3.3 Payment Processing</h3>
            <ul className="list-disc list-inside text-slate-600 mb-4 ml-4">
            ...
            <h3 className="text-xl font-semibold text-slate-800 mb-3">3.4 Security and Fraud Prevention</h3>
            <ul className="list-disc list-inside text-slate-600 mb-4 ml-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-slate-800 mb-4">4. AI and Machine Learning</h2>
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-slate-800 mb-3 mt-6">5.1 We DO NOT Sell Your Data</h3>
            <p className="text-slate-600 mb-4">
              We do not sell, rent, or trade your personal information to third parties for marketing purposes.
            </p>

            <h3 className="text-xl font-semibold text-slate-800 mb-3">5.2 Third-Party Service Providers</h3>
            <p className="text-slate-600 mb-3">We share limited data with:</p>
            <ul className="list-disc list-inside text-slate-600 mb-4 ml-4">
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-600 mb-3">We implement industry-standard security measures:</p>
            <ul className="list-disc list-inside text-slate-600 mb-4 ml-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-slate-800 mb-3 mt-6">8.1 Access and Export</h3>
            <ul className="list-disc list-inside text-slate-600 mb-4 ml-4">
            ...
            <h3 className="text-xl font-semibold text-slate-800 mb-3">8.2 Correction and Update</h3>
            <ul className="list-disc list-inside text-slate-600 mb-4 ml-4">
              <li>Update your email and preferences anytime in your account settings</li>
            </ul>

            <h3 className="text-xl font-semibold text-slate-800 mb-3">8.3 Delete Account</h3>
            <ul className="list-disc list-inside text-slate-600 mb-4 ml-4">
              <li>Request account deletion (contact support@prepgenie.co.in)</li>
              <li>All personal data will be deleted within 30 days</li>
            </ul>

            <h3 className="text-xl font-semibold text-slate-800 mb-3">8.4 Marketing Communications</h3>
            <ul className="list-disc list-inside text-slate-600 mb-4 ml-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-slate-800 mb-4">9. Cookies and Tracking</h2>
            <p className="text-slate-600 mb-3">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-slate-800 mb-4">12. Changes to Privacy Policy</h2>
            <p className="text-slate-600">
          ...
          <div className="mt-12 p-6 bg-[#E8EAFF] rounded-xl border border-[#90CAF9]">
