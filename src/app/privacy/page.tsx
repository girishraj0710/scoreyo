      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside  mb-4 ml-4" style={{ color: "var(--foreground)" }}>
          ...
          <section className="mb-8">
            ...
            <p className=" mb-3" style={{ color: "var(--foreground)" }}>We use your information to:</p>
          ...
          <section className="mb-8">
            ...
            <p className=" mb-3" style={{ color: "var(--foreground)" }}>We share limited data with:</p>
            <ul className="list-disc list-inside  mb-4 ml-4" style={{ color: "var(--foreground)" }}>
          ...
          <section className="mb-8">
            ...
            <p className=" mb-3" style={{ color: "var(--foreground)" }}>We implement industry-standard security measures:</p>
            <ul className="list-disc list-inside  mb-4 ml-4" style={{ color: "var(--foreground)" }}>
          ...
          <section className="mb-8">
            ...
            <p className=" mb-3" style={{ color: "var(--foreground)" }}>You have the right to:</p>
