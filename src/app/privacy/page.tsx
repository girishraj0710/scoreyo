...
export const metadata = {
  title: "Privacy Policy | Scoreyo",
  description: "Privacy Policy for Scoreyo - How we collect, use, and protect your data",
};
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <section className="mb-8">
            ...
            <p style={{ color: "var(--foreground-secondary)" }}>
              If Scoreyo is acquired or merged with another company, your information may be transferred to
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside mb-4 ml-4" style={{ color: "var(--foreground-secondary)" }}>
              ...
              <li>Request a copy of your data (email us at support@scoreyo.in)</li>
            </ul>
            ...
            <ul className="list-disc list-inside mb-4 ml-4" style={{ color: "var(--foreground-secondary)" }}>
              <li>Request account deletion (contact support@scoreyo.in)</li>
          ...
          <section className="mb-8">
            ...
            <p className="mb-3" style={{ color: "var(--foreground-secondary)" }}>
              Scoreyo is intended for users aged 13 and above. We do not knowingly collect information from
          ...
          <section className="mb-8">
            ...
            <p style={{ color: "var(--foreground-secondary)" }}>
              ...
              By using Scoreyo, you consent to the transfer of your information to these locations.
            </p>
          </section>
