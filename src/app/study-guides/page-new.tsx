            ...
            <div className="max-w-4xl mx-auto px-8 py-16">
              <div className="text-center mb-12">
                ...
                <p className="text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
                  Comprehensive learning materials from dimensional model. {exams.length} exams, {exams.reduce((sum, e) => sum + e.subjectCount, 0)} subjects, {exams.reduce((sum, e) => sum + e.topicCount, 0)} topics.
                </p>
              </div>
