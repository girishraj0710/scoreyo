    ...
    <AccessibilityWrapper>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <section className="text-center mb-8 md:mb-12">
          <h1 className="font-heading text-3xl sm:text-4xl md:text-5xl font-bold mb-3 md:mb-4 px-2 text-[#16213E] dark:text-white">
            Smart Exam Prep
          </h1>
        <p className="font-sans text-base sm:text-lg max-w-3xl mx-auto mb-4 md:mb-6 leading-relaxed px-2 text-[#5A6478] dark:text-slate-400">
      ...
      {!showFullFlow && lastQuiz && !selectedCategory && (
        <section className="mb-6 md:mb-8">
          <div className="bg-gradient-to-r from-[#F26A4B] to-[#F58972] rounded-2xl p-5 sm:p-6 text-white shadow-xl border border-transparent">
            <div className="flex items-start justify-between mb-3">
              <div>
                <div className="font-sans text-xs sm:text-sm font-bold tracking-[0.25em] uppercase text-white/90 mb-1" style={{ letterSpacing: '0.25em' }}>
                  QUICK START
                </div>
                <h3 className="font-heading text-lg sm:text-xl font-bold">
                  {getExamById(lastQuiz.examId)?.name || "Suggested Quiz"}
                </h3>
                <p className="font-sans text-sm text-white/90 mt-1">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <a
                ...
                className="flex-1 font-sans font-semibold py-3 px-4 rounded-xl text-center transition-all duration-500" style={{ background: "rgba(0, 0, 0, 0.2)", color: "#ffffff" }}
                onMouseEnter={(e) => {
              ...
              <button
                ...
                className="sm:w-auto font-sans text-white font-medium py-3 px-4 rounded-xl transition-all duration-500 border-2"
                style={{
      ...
      {(showFullFlow || !lastQuiz) && !selectedCategory && (
        <section ref={categoryRef} className="mb-6 md:mb-8">
          <div className="mb-3 md:mb-4">
            <div className="font-sans text-xs font-bold tracking-[0.25em] uppercase text-[#F26A4B] dark:text-[#F58972] mb-2" style={{ letterSpacing: '0.25em' }}>
              STEP 1
            </div>
            <h2 className="font-heading text-base sm:text-lg font-semibold text-[#16213E] dark:text-white">
        ...
        <section ref={examRef} className="mb-6 md:mb-8">
          <div className="mb-3 md:mb-4 flex items-center justify-between">
            ...
            <button
              ...
              className="font-sans text-xs sm:text-sm font-medium text-[#F26A4B] dark:text-[#F58972] hover:underline"
            >
              ← Change
            </button>
          </div>
      ...
      {selectedTopic && (
        <section ref={settingsRef} className="mb-8 md:mb-12">
          <div className="rounded-xl sm:rounded-2xl border-2 p-4 sm:p-6 shadow-lg max-w-lg mx-auto bg-white dark:bg-slate-900" style={{ borderColor: "#e2e8f0" }}>
            ...
            <button
              ...
              className="w-full py-3 mb-3 border-2 border-[#F26A4B] hover:border-[#409464] bg-white hover:bg-[#409464] text-[#F26A4B] hover:text-white font-sans font-semibold rounded-xl shadow-md hover:shadow-lg transition-all duration-500 cursor-pointer flex items-center justify-center gap-2"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="w-full py-3 bg-[#F26A4B] hover:bg-[#E15838] text-white font-sans font-semibold rounded-xl shadow-lg hover:shadow-xl text-lg transition-all duration-500 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
            >
