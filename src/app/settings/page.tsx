...
export default function SettingsPage() {
    ...
    return (
      <div className="max-w-3xl mx-auto px-4 py-16 text-center">
        <div className=" dark:bg-gray-800 rounded-2xl p-12 shadow-lg border  dark:border-gray-700" style={{ borderColor: "var(--card-border)" }} style={{ background: "var(--card-bg)" }}>
          ...
          <p className=" dark:text-gray-400" style={{ color: "var(--foreground)" }}>
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8">
      <h1 className="text-2xl font-bold  dark:text-white mb-2" style={{ color: "var(--foreground)" }}>Settings</h1>
      <p className=" dark:text-gray-400 text-sm mb-8" style={{ color: "var(--foreground)" }}>
      ...
      <section className=" dark:bg-gray-800 rounded-2xl p-6 shadow-sm border  dark:border-gray-700 mb-6" style={{ borderColor: "var(--card-border)" }} style={{ background: "var(--card-bg)" }}>
        ...
        <div className="space-y-4">
          {/* Name */}
          <div>
            <label className="block text-sm font-medium  dark:text-gray-300 mb-1.5" style={{ color: "var(--foreground)" }}>
              Full Name
            </label>
            <div className="relative">
              <User className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 " style={{ color: "var(--foreground)" }} />
              <input
                type="text"
                value={name}
          ...
          <div>
            ...
            <div className="relative">
              <Mail className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 " style={{ color: "var(--foreground)" }} />
              <input
                type="email"
                value={email}
                disabled
            ...
            <p className="text-xs  mt-1" style={{ color: "var(--foreground)" }}>Email cannot be changed as it&apos;s used for login</p>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <Phone className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 " style={{ color: "var(--foreground)" }} />
              <input
                type="tel"
                value={phone}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <div className="relative">
                <Calendar className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 " style={{ color: "var(--foreground)" }} />
                <input
                  type="number"
                  value={age}
            ...
            <div>
              ...
              <div className="relative">
                <MapPin className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 " style={{ color: "var(--foreground)" }} />
                <input
                  type="text"
                  value={location}
          ...
          <div>
            ...
            <div className="relative">
              <GraduationCap className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 " style={{ color: "var(--foreground)" }} />
              <select
              ...
              <ChevronRight className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4  rotate-90" style={{ color: "var(--foreground)" }} />
            </div>
          </div>
      ...
      <section className=" dark:bg-gray-800 rounded-2xl p-6 shadow-sm border  dark:border-gray-700 mb-6" style={{ borderColor: "var(--card-border)" }} style={{ background: "var(--card-bg)" }}>
        ...
        {/* Daily Goal */}
        <div className="mb-6">
          <label className="block text-sm font-medium  dark:text-gray-300 mb-3" style={{ color: "var(--foreground)" }}>
            Daily Question Goal
          </label>
          ...
          <p className="text-xs  mt-2" style={{ color: "var(--foreground)" }}>Questions per day target</p>
        </div>
      ...
      <section className=" dark:bg-gray-800 rounded-2xl p-6 shadow-sm border  dark:border-gray-700 mb-6" style={{ borderColor: "var(--card-border)" }} style={{ background: "var(--card-bg)" }}>
        ...
        {/* Dark Mode */}
        <div className="flex items-center justify-between p-4  dark:bg-gray-700/50 rounded-xl" style={{ background: "var(--background)" }}>
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-sm font-medium  dark:text-gray-200" style={{ color: "var(--foreground)" }}>
                Dark Mode
              </div>
      ...
      <section className=" dark:bg-gray-800 rounded-2xl p-6 shadow-sm border  dark:border-gray-700 mb-6" style={{ borderColor: "var(--card-border)" }} style={{ background: "var(--card-bg)" }}>
        ...
        {subscription ? (
          <div className="space-y-4">
            ...
            {subscription.isPro && subscription.subscription && (
              <div className="grid grid-cols-2 gap-3 text-sm">
                <div className="p-3  dark:bg-gray-700/50 rounded-lg" style={{ background: "var(--background)" }}>
                  <div className=" text-xs" style={{ color: "var(--foreground)" }}>Started</div>
                  <div className="font-medium  dark:text-gray-200 mt-0.5" style={{ color: "var(--foreground)" }}>
                    {formatDate(subscription.subscription.started_at)}
                  </div>
                </div>
                <div className="p-3  dark:bg-gray-700/50 rounded-lg" style={{ background: "var(--background)" }}>
                  <div className=" text-xs" style={{ color: "var(--foreground)" }}>Expires</div>
                  <div className="font-medium  dark:text-gray-200 mt-0.5" style={{ color: "var(--foreground)" }}>
          ...
          <div className="animate-pulse h-20  dark:bg-gray-700 rounded-xl" style={{ background: "var(--background)" }} />
        )}
      </section>
      ...
      <section className=" dark:bg-gray-800 rounded-2xl p-6 shadow-sm border  dark:border-gray-700 mb-6" style={{ borderColor: "var(--card-border)" }} style={{ background: "var(--card-bg)" }}>
        ...
        <p className="text-xs  mt-4" style={{ color: "var(--foreground)" }}>
      ...
      <section className=" dark:bg-gray-800 rounded-2xl p-6 shadow-sm border  dark:border-gray-700 mb-6" style={{ borderColor: "var(--card-border)" }} style={{ background: "var(--card-bg)" }}>
        ...
        <div className="space-y-3">
          {/* Account Info */}
          <div className="p-4  dark:bg-gray-700/50 rounded-xl" style={{ background: "var(--background)" }}>
            <div className="flex items-center justify-between">
              <div>
                <div className="text-sm font-medium  dark:text-gray-200" style={{ color: "var(--foreground)" }}>Account ID</div>
                <div className="text-xs  mt-0.5 font-mono" style={{ color: "var(--foreground)" }}>{user.id}</div>
              </div>
              <div className="text-right">
                <div className="text-sm font-medium  dark:text-gray-200" style={{ color: "var(--foreground)" }}>Member Since</div>
                <div className="text-xs  mt-0.5" style={{ color: "var(--foreground)" }}>{formatDate(user.created_at)}</div>
              </div>
            </div>
          </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-between p-4 bg-slate-50 hover: dark:bg-gray-700/50 dark:hover:bg-gray-700 rounded-xl transition group" style={{ background: "var(--background)" }}
          >
            <div className="flex items-center gap-3">
              <LogOut className="w-5 h-5 text-slate-500 group-hover: dark:text-gray-400" style={{ color: "var(--foreground)" }} />
              <span className="text-sm font-medium  dark:text-gray-200" style={{ color: "var(--foreground)" }}>Logout</span>
            </div>
...
function NotificationToggle({
  ...
  return (
    <div className="flex items-center justify-between p-4  dark:bg-gray-700/50 rounded-xl" style={{ background: "var(--background)" }}>
      <div>
        <div className="text-sm font-medium  dark:text-gray-200" style={{ color: "var(--foreground)" }}>{label}</div>
        <div className="text-xs  mt-0.5" style={{ color: "var(--foreground)" }}>{description}</div>
      </div>
      <button
