            ...
            {reports.map((report) => (
              ...
              >
                ...
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="px-4 py-2 bg-[#4255FF] text-white rounded-lg hover:bg-[#3242CC] transition-colors"
                    >
                      ✏️ Edit Question
                    </button>
                    <button
                ...
                <div className="border-t pt-4">
                  ...
                  <div className="p-3 bg-[#E8EAFF] rounded">
          ...
          <div className="bg-white rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto p-8">
            ...
            <div className="flex justify-end gap-3">
              ...
              <button
                ...
                disabled={saving}
                className="px-6 py-2 bg-[#4255FF] text-white rounded-lg hover:bg-[#3242CC] transition-colors disabled:opacity-50"
              >
