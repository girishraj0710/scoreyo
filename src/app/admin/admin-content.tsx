      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <Link
            ...
            className="px-6 py-3 bg-[#00A1E0] text-white rounded-lg hover:bg-[#0070A8] transition-colors font-medium flex items-center gap-2"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-md p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between p-3 bg-[#E6F4F9] rounded-lg">
                <span className="text-sm font-medium text-gray-700">
                  Active (30 days)
                </span>
                <span className="text-lg font-bold text-[#0070A8]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-xl shadow-md p-6">
            ...
            <div className="flex items-center gap-6 mb-4 text-sm">
              <div className="flex items-center gap-2">
                <div className="w-4 h-4 bg-[#E6F4F9]0 rounded"></div>
                  ...
                  <div className="flex-1 space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="flex-1 bg-gray-100 rounded-full h-5">
                        <div
                          className="bg-[#E6F4F9]0 h-5 rounded-full transition-all"
                          style={{
                            width: `${Math.max(
                              5,
                              (item.quizzes /
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-2 mb-1">
                        ...
                        <span className={`text-sm font-bold whitespace-nowrap ${
                          item.count === 0 ? 'text-gray-400' : 'text-[#00A1E0]'
                        }`}>
                      ...
                      <div className="w-full bg-gray-100 rounded-full h-2">
                        <div
                          className={`h-2 rounded-full transition-all ${
                            item.count === 0 ? 'bg-gray-300' : 'bg-[#00A1E0]'
                          }`}
                          style={{
        ...
        <div className="mt-8 bg-white rounded-xl shadow-md p-6">
          ...
          {topicBreakdownLoading && (
            <div className="mb-4 p-4 bg-[#E6F4F9] border border-blue-200 rounded-lg text-sm text-[#0070A8] flex items-center gap-2">
              <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-[#00A1E0]"></div>
                        ...
                        <td className="px-2 py-2 text-xs overflow-hidden">
                          <span className={`px-2 py-0.5 rounded-full text-[10px] font-medium capitalize ${
                            item.scope === 'universal'
                              ...
                              : 'bg-blue-100 text-[#0070A8]'
                          }`}>
                            {item.scope}
                          </span>
                        </td>
                        <td className="px-2 py-2 text-xs text-right font-semibold text-[#00A1E0]">
                          {item.exam_count}
                        </td>
