...
export function DPPCard() {
  ...
  if (loading) {
    return (
      <div className="bg-gradient-to-br from-indigo-600 to-violet-500 rounded-2xl p-6 shadow-lg text-white">
        ...
        {!completed ? (
          <>
            ...
            <button
              ...
              className="w-full px-4 py-3 bg-white text-indigo-600 font-bold rounded-xl hover:bg-slate-50 transition-colors flex items-center justify-center gap-2"
            >
