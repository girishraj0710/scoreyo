    ...
    <div className="mt-6 space-y-4">
      ...
      {explanation.formula && (
        <div className="p-4 bg-indigo-50 rounded-xl border border-indigo-200">
          ...
          <div className="bg-white px-3 py-2 rounded-lg border border-indigo-200 font-mono text-sm text-indigo-900 mb-2">
            {explanation.formula}
          </div>
          {explanation.calculation && (
            <>
              <div className="text-indigo-700 font-semibold text-xs mb-1 mt-3">Step-by-step:</div>
              <pre className="text-xs text-indigo-800 leading-relaxed whitespace-pre-wrap font-mono bg-white px-3 py-2 rounded-lg border border-indigo-200">
                {explanation.calculation}
              </pre>
            </>
          )}
      ...
      <div className="p-3 bg-emerald-100 rounded-lg border-2 border-emerald-400 flex items-center gap-3">
        <span className="shrink-0 w-8 h-8 rounded-full bg-emerald-500 text-white flex items-center justify-center text-sm font-bold">
          {String.fromCharCode(65 + correctAnswer)}
        </span>
        <div className="flex-1">
          <div className="text-xs text-emerald-600 font-semibold mb-0.5">✓ Correct Answer</div>
