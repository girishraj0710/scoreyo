...
// Study modes for carousel - Emergent exact match + Scoreyo additions
const STUDY_MODES = [
  ...
  { id: 8, title: "AI Tutor", headerColor: "#3B7A8A", cta: "Ask Scoreyo", preview: "chat" },
        ...
        <div className="w-full px-6 md:px-10 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <a href="/" className="flex items-center gap-2">
              ...
              <span className="font-heading text-lg font-bold text-[#16213E]">Scoreyo</span>
            </a>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        ...
        <section id="features" className="py-16 bg-[#FAF8F5]">
          ...
          <div
            ...
            style={{ width: "min(calc(100vw - 2rem), 1360px)" }}
          >
                      ...
                      <div className="ml-3 mt-0 mb-0 mr-0 rounded-tl-xl rounded-bl-xl bg-white/95 backdrop-blur-sm ring-1 ring-white/60 shadow-[0_10px_30px_-10px_rgba(22,33,62,0.25)] p-4 pb-6 flex-1 min-h-[220px] relative overflow-visible">
                        ...
                        {mode.preview === "chat" && (
                          <div className="space-y-2">
                            ...
                            <div className="text-xs bg-[#3B7A8A]/10 rounded-lg px-3 py-2 text-[#16213E]"><span className="font-semibold text-[#3B7A8A]">Scoreyo:</span> Right to Life & Personal Liberty — interpreted broadly to include dignity, privacy…</div>
        ...
        {/* 5. WHY SCOREYO - Premium Snake Layout */}
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="text-center mb-8 md:mb-10">
              ...
              <p className="text-[#5A6478] text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
                Most students don't fail because they lack resources. They fail because they don't know what to study, how deep to study, and whether they are improving. Scoreyo gives you clarity—and clarity leads to results.
              </p>
            </div>
