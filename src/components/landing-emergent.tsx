...
// Study modes for carousel (using simple 3D renders from Unsplash)
const STUDY_MODES = [
  { id: 1, image: "https://illustrations.popsy.co/amber/student-going-to-school.svg", title: "Topic Practice", desc: "Master specific topics with customizable quizzes. Choose difficulty and question count.", headerColor: "bg-[#FFE8D9]", cta: "Start Learning" },
  { id: 2, image: "https://illustrations.popsy.co/green/clipboard.svg", title: "Mock Tests", desc: "Full-length timed tests that simulate real exam conditions. Get detailed performance reports.", headerColor: "bg-[#D1FAE5]", cta: "Take Mock Test" },
  { id: 3, image: "https://illustrations.popsy.co/blue/abstract-art.svg", title: "Smart Review", desc: "AI-powered spaced repetition. Review at the perfect moment to maximize retention.", headerColor: "bg-[#DBEAFE]", cta: "Review Now" },
  { id: 4, image: "https://illustrations.popsy.co/violet/website-designer.svg", title: "Level Mode", desc: "Progress through levels from beginner to expert. Unlock harder topics as you master basics.", headerColor: "bg-[#FCE7D9]", cta: "Play Levels" },
  { id: 5, image: "https://illustrations.popsy.co/red/timed-work.svg", title: "Pressure Mode", desc: "Build mental toughness with adaptive timers. Train your brain to perform under stress.", headerColor: "bg-[#FFE4E6]", cta: "Start Training" },
  { id: 6, image: "https://illustrations.popsy.co/amber/calendar.svg", title: "Daily Practice", desc: "10 questions, 10 minutes. Build your streak and stay consistent every day.", headerColor: "bg-[#CFFAFE]", cta: "Start Challenge" },
  { id: 7, image: "https://illustrations.popsy.co/blue/opened-book.svg", title: "Master English", desc: "TOEFL prep, Business English, and Foundation skills. Build vocabulary, grammar, and fluency.", headerColor: "bg-[#DBEAFE]", cta: "Learn English" },
  { id: 8, image: "https://illustrations.popsy.co/violet/folder-with-files.svg", title: "Smart Flashcards", desc: "Interactive flashcards with active recall. Flip, shuffle, and master concepts faster.", headerColor: "bg-[#E9D5FF]", cta: "Create Cards" },
  { id: 9, image: "https://illustrations.popsy.co/amber/man-reading-a-book.svg", title: "Study Guides", desc: "Comprehensive topic summaries and notes. Perfect for quick revision before exams.", headerColor: "bg-[#FEF3C7]", cta: "Browse Guides" },
];
