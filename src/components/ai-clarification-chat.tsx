    ...
    <div className="mt-4 p-4 bg-gradient-to-br from-purple-50 to-indigo-50 rounded-xl border-2 border-purple-200">
      <div className="flex items-center gap-2 mb-3">
        ...
        <div>
          ...
          <div className="text-xs text-purple-600">Get instant clarification</div>
        </div>
      </div>
      ...
      {aiResponse && (
        <div className="space-y-3">
          ...
          <button
            ...
            className="w-full px-3 py-2 text-xs bg-purple-100 text-purple-700 rounded-lg hover:bg-purple-200 transition-colors font-medium"
          >
      ...
      <button
        ...
        className="mt-3 w-full text-xs text-purple-600 hover:text-purple-800"
      >
        Close
      </button>
    </div>
