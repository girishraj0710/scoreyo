      ...
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-1">
          ...
          <nav className="hidden sm:flex items-center gap-1">
            ...
            <Link href="/review" className="px-3 py-2 text-sm font-medium text-slate-600 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg">
              {t("review")}
            </Link>
            <Link href="/mock-test" className="px-3 py-2 text-sm font-medium text-slate-600 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg">
              {t("mockTests")}
            </Link>
            <Link href="/reports" className="px-3 py-2 text-sm font-medium text-slate-600 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg">
              {t("reports")}
            </Link>
