      ...
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-1">
          ...
          <nav className="hidden sm:flex items-center gap-1">
            ...
            <a href="/dashboard" className="px-3 py-2 text-sm font-medium text-slate-600 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg">
              {t("dashboard")}
            </a>
            <a href="/review" className="px-3 py-2 text-sm font-medium text-slate-600 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg">
              {t("review")}
            </a>
            <a href="/mock-test" className="px-3 py-2 text-sm font-medium text-slate-600 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg">
              {t("mockTests")}
            </a>
            <a href="/reports" className="px-3 py-2 text-sm font-medium text-slate-600 hover:text-indigo-600 hover:bg-indigo-50 rounded-lg">
              {t("reports")}
            </a>
            <a href="/pricing" className="px-3 py-2 text-sm font-medium text-amber-600 hover:text-amber-700 hover:bg-amber-50 rounded-lg flex items-center gap-1">
              ...
              {showMenu && (
                <div className="absolute right-0 mt-1 w-48 bg-white rounded-xl shadow-lg border border-slate-200 z-[70] py-1">
                  ...
                  <div className="sm:hidden border-b border-slate-100">
                    ...
                    <a href="/dashboard" className="block px-4 py-2 text-sm text-slate-600 hover:bg-slate-50">{t("dashboard")}</a>
                    <a href="/review" className="block px-4 py-2 text-sm text-slate-600 hover:bg-slate-50">{t("review")}</a>
                    <a href="/mock-test" className="block px-4 py-2 text-sm text-slate-600 hover:bg-slate-50">{t("mockTests")}</a>
                    <a href="/reports" className="block px-4 py-2 text-sm text-slate-600 hover:bg-slate-50">{t("reports")}</a>
                    <a href="/pricing" className="block px-4 py-2 text-sm text-amber-600 hover:bg-amber-50 font-medium">{t("pricing")}</a>
                  </div>
                  <button
                    onClick={() => {
                      setShowMenu(false);
