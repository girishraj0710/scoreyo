        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-6">
          <div>
            ...
            <ul className="space-y-2 text-xs text-slate-600">
              ...
              <li><a href="/mock-test" className="hover:text-indigo-600 transition-colors">Mock Tests</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-slate-600">
              ...
              <li><a href="mailto:support@prepgenie.co.in" className="hover:text-indigo-600 transition-colors">Email Support</a></li>
            </ul>
          </div>
          <div>
