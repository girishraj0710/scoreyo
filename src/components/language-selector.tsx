        ...
        <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-slate-200 z-[100] py-1 max-h-80 overflow-y-auto">
          ...
          {languages.map((lang) => (
            <button
              ...
              className={`w-full text-left px-3 py-2.5 text-sm flex items-center gap-3 hover:bg-indigo-50 transition-colors ${
                locale === lang.code ? "bg-indigo-50 text-indigo-700 font-medium" : "text-slate-700"
              }`}
            >
