                ...
                {state !== "locked" && (
                  ...
                  >
                    ...
                    <div className="flex flex-wrap gap-2 text-xs">
                      <span className="px-2 py-1 bg-[#E3F2FD] text-[#3B7FD9] rounded-full">
                ...
                >
                  {state === "completed" ? (
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-2 bg-white border-2 border-[#90CAF9] text-[#4F9CF9] rounded-lg hover:bg-[#E3F2FD] text-sm font-medium transition-all"
                    >
                    ...
                    <button
                      onClick={() => onLevelClick(level)}
                      className="flex items-center gap-2 px-5 py-2 bg-[#4F9CF9] text-white rounded-lg text-sm font-semibold shadow-lg transition-all"
                    >
      ...
      <div className="mt-12 bg-white rounded-2xl shadow-lg border-2 border-slate-200 p-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="text-center">
            <div className="text-3xl font-bold text-[#4F9CF9]">
