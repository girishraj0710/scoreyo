# Resend Email Domain Setup for scoreyo.in
...
Go to: https://dcc.godaddy.com/manage/scoreyo.in/dns
...
2. Use DNS checker: https://dnschecker.org/#TXT/resend._domainkey.scoreyo.in
...
Until scoreyo.in is verified, emails will continue using:
- `noreply@prepgenie.co.in` (verified domain)

After scoreyo.in is verified, all emails will use:
- `noreply@scoreyo.in` ✅
