...
curl -X POST https://prepgenie.co.in/api/cron/annual-syllabus-update \
...
# Check distribution
sqlite3 data/prepgenie.db "SELECT exam_id, syllabus_year, is_current_syllabus, COUNT(*) FROM exam_questions GROUP BY exam_id, syllabus_year, is_current_syllabus;"
```
...
**This system ensures PrepGenie stays current with exam patterns forever!** 🚀
