# 🚀 Scoreyo: Million-User Scaling Plan
...
turso db shell scoreyo-girishraj0710
...
TURSO_SYNC_URL=libsql://scoreyo-girishraj0710-singapore.turso.io
```
...
```bash
turso db replicas create scoreyo-girishraj0710 --location sgn  # Singapore
turso db replicas create scoreyo-girishraj0710 --location iad  # US East
```
...
```bash
turso db backup enable scoreyo-girishraj0710 --schedule daily
```
